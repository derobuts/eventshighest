...
{
    public class OrderQueueService : IOrderBackgroundQueue
    {
        private ConcurrentQueue<Func<CancellationToken, Task>> _workItems = new ConcurrentQueue<Func<CancellationToken, Task>>();
        private readonly ILogger _logger;
        private SemaphoreSlim _signal = new SemaphoreSlim(0);//initial count of threads i allow
        ...
        //add background worker and return
